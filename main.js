    ...
    getRemoteSchema(
        'https://ohb-server1.apps.selise.dev/api/v1/graphql',
        {
            ...
            headers: {
                ...
                'Authorization': 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIwMDUwMTI0Ni0xMjVkLTRjNTQtYmI0My1hYjI2OGJiMTE0ZDUiLCJzdWIiOiIxMDciLCJzY3AiOiJ1c2VyIiwiYXVkIjpudWxsLCJleHAiOjE3MTg4NTk4NDAsImlhdCI6MTcxODY4NzA0MH0.L4Zz5irfDJqQCmxNMFHXh0afFU30oeafZri6h5-U118'
            },
        }
    ).then(res => {
